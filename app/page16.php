                    ...
                    <div class="col-sm-8 col-sm-offset-2" style="background-color: rgba(33,33,33,0.9);">
                      <br>
                        <div class="mbr-header mbr-header--center mbr-header--std-padding">
                            <h2 style="color:white" class="mbr-header__text">Registrar datos de horarios</h2>
                        </div>
                        <form action="" method="POST" name="actualform">
                            ...
                            <div class="form-group">
                             ...
                             <div class="mbr-buttons mbr-buttons--right"><input type="submit" class="mbr-buttons__btn btn btn-lg btn-danger" value="Ingresar" name="creadat"/></div>
                        </form>
                        <?php
                          ...
                          if(isset($_POST['creadat']))
                          {
                            ...
                            $jor=$_POST['jornada'];
                            $exiseu=0;
                             $resule=mysqli_query($coneccion,"SELECT * FROM horarios WHERE Id_emple='$idins' AND Id_curso='$idcur' AND HoraInicio='$hi' AND HoraFin='$hf' AND Jornada='$jor'");
                            ...
                            if($exiseu==1)
                            {
                              echo "<h2 style=\"color:white;\">El horario ya está registrado</h2>";
                            }
                            else
                            {
                              $resul=mysqli_query($coneccion,"INSERT INTO horarios (Id_emple,Id_curso,HoraInicio,HoraFin, Jornada)
                              values ('$idins','$idcur','$hi','$hf','$jor')");
                              echo "<h2 style=\"color:white;\">Horario registrado correctamente<h2>";
                            }
                          }
                        ?>
                        <br>
