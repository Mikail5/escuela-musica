                    ...
                    <div class="col-sm-8 col-sm-offset-2" style="background-color: rgba(33,33,33,0.9);">
                      <br><br>
                        <div class="mbr-header mbr-header--center mbr-header--std-padding">
                            <h2 style="color:white" class="mbr-header__text">Actualizar información de cursos</h2>
                        </div>
                        <form action="" method="POST" name="actualform">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <input class="form-control" name="nomcur" placeholder="Nombre del curso">
                            </div>
                        ...
                        <?php
                          ...
                          if(isset($_POST['actualdat']))
                          {
                            ...
                            $nomcu=$_POST['nomcur'];
                            $exis=0;
                            $resul=mysqli_query($coneccion,"SELECT * FROM curso WHERE Id_curso='$idcur'");
                            ...
                            if($exis==0)
                            {
                              echo "Curso diligenciado no existe";
                            }
                            else
                            {
                              $UpdateSQL="UPDATE curso SET
                              Id_curso='$idcur',
                              NomCurso='$nomcu'
