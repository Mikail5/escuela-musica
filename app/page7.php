                    ...
                    <div class="col-sm-8 col-sm-offset-2" style="background-color: rgba(33,33,33,0.9);">
                      <br><br>
                        <div class="mbr-header mbr-header--center mbr-header--std-padding">
                          <img width="200" height="200" src="assets/images/1.png">
                            <h2  style="color:white"; class="mbr-header__text">
                              Bienvenido <?=$_SESSION['usuario']['NomUsua'] ?></h2>
                            <h3 style="color:white";>En esta plataforma podras realizar tanto cambios en los datos de los horarios o estudiantes, como crear nuevos horarios y registrar estudiantes nuevos y su matricula.</h3>
                            <br>
                        </div>
